...
*/
public class PermutationGenerator_WithoutGenerics
{
   private String word;
   ...
   */
   public PermutationGenerator_WithoutGenerics(String aWord)
   {
      word = aWord;
   }
   ...
   */
   public ArrayList<String> getPermutations()
   {
      ...
      for (int i = 0; i < word.length(); i++)
      {
         ...
         PermutationGenerator_WithoutGenerics shorterPermutationGenerator
               = new PermutationGenerator_WithoutGenerics(shorterWord);
